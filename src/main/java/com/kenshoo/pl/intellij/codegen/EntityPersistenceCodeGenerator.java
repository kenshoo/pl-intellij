...
public class EntityPersistenceCodeGenerator {
    ...
    public String generate(String entityClassName, String entityPersistenceClassName) {
        return new StringBuilder()
                ...
                .append(NEW_LINE)
                .append("import static com.kenshoo.pl.entity.spi.helpers.CompoundChangesValidatorFactory.buildChangesValidator;")
                .append(NEW_LINE)
                .append(NEW_LINE)
                ...
                .append(NEW_LINE)
                .append("    .withValidator(buildChangesValidator(").append(entityClassName).append(".INSTANCE, List.of(")
                .append(NEW_LINE)
                .append("     /* simple validators come here */ ")
                .append(NEW_LINE)
                .append("     )));")
                .append(NEW_LINE)
                .append("}")
